      ...
      <div className="box">
        <div className="inner-box">
          ...
          <div className="carousel">
            <img className="wall" style={{ height: "500px" }} src="https://img.freepik.com/free-vector/bank-reception-area-cartoon-vector_33099-1304.jpg?w=2000" alt="Bank Reception" />
          </div>
        </div>
      </div>
    </div>
